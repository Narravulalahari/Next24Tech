...
def saveinfo():
    save()
    msg()
l0=Label(root,text="Course Registration Form",width=25,font=("times",20,"bold"),bg="pink",fg="blue")
l0.place(x=70,y=50)
...
l3=Label(root,text="Mobileno",width=20,font=("times",12,"bold"),anchor="w",bg="grey")
l3.place(x=70,y=320)
...
option=("C","C++","Python","Javascript","Ruby","Java")
