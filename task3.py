...
# Title label
title_label = tk.Label(root, text="Lyrics Fetcher", font=("Helvetica", 24, "bold"), bg="#330099", fg="#FF00FF")
...
# Fetch lyrics button
fetch_button = tk.Button(root, text="Fetch Lyrics", command=fetch_lyrics, font=("Helvetica", 14), bg="#CC6699", fg="#282c34", padx=10, pady=5)
